...
$env.jupyterhub.shared_volume = {
  ...
  home_size: 100, # Total size of home dir volume, accounting for all users; In GB
...
$env.jupyterhub.jhub = {
  ...
  admins: [ "aaw05260" ], # E.g. [ admin1 admin2 admin3 ]; Unidata admins added automatically, putting them here is unnecessary
