...
$env.jupyterhub.shared_volume = {
  ...
  home_size: 350, # Total size of home dir volume, accounting for all users; In GB
  data_size: 25, # Total size of /share mount, in GB; if this is left null, no additional storage is allocated for shared data
