...
sed -i "s/Featured-Ubuntu[0-9]*/Ubuntu2204Minimal/g" cluster.tfvars
...
sed -i "s/k8s_allowed_remote_ips = \[\"0.0.0.0\/0\"\]/k8s_allowed_remote_ips =  \[\"128.117.164.80\/28\",\"128.117.165.80\/28\",\"128.117.144.0\/24\",\"128.117.145.0\/24\",\"149.165.152.95\"\]/g" cluster.tfvars
...
echo
echo --------------------------------------------------------------------------------
echo Once VMs are ready, run remove-bloat.sh followed by kube-setup2.sh
