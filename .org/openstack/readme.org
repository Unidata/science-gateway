...
Then, modify =~/jetstream_kubespray/inventory/zonca/cluster.tfvars= to specify the number of nodes in the cluster and the size ([[#h-958EA909][flavor]]) of the VMs. For example,
