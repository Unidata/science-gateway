...
Create an ~m1.medium~ VM with the [[file:../../openstack/readme.org::#h:03303143][Jetstream OpenStack API]]. [[file:../../openstack/readme.org::#h:9BEEAB97][Create and attach]] a 100GB =/repository= volume to that VM. Work with Unidata system administrator staff to have this VM's IP address resolve to =ramadda-jetstream.unidata.ucar.edu=.
...
[[file:../../openstack/readme.org::#h:D6B1D4C2][Open port]] ~80~ on the RAMADDA VM via OpenStack. Port ~80~ requests will be forwarded to ~8080~ inside the RAMADDA Docker container.
