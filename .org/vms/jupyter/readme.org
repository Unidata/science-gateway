...
[[https://developers.globus.org/][Globus OAuth capability]] is available for user authentication. The instructions [[https://oauthenticator.readthedocs.io/en/latest/getting-started.html#globus-setup][here]] are relatively straightforward.
