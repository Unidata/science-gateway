...
# c.JupyterHub.bind_url = 'http://gpu-test4.tg-ees220002.projects.jetstream-cloud.org:8000'
...
#  Default: set()
c.Authenticator.allowed_users = {'julienchastang', 'ThomasMGeo', 'robertej09'}
...
c.GitHubOAuthenticator.oauth_callback_url = 'https://<jetstream-gpu>.jetstream-cloud.org:443/oauth_callback'
