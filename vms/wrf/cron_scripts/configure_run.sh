...
sed -i "s/START_MINUTE_D1/${START_MINUTE_D1}/" ${PROJ_DIR}/${DATE}/config/namelist.input
...
sed -i "s/START_MINUTE_D2/${START_MINUTE_D2}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/START_SECOND_D2/${START_SECOND_D2}/" ${PROJ_DIR}/${DATE}/config/namelist.input

# End date: Domain 1
sed -i "s/END_YEAR_D1/${END_YEAR_D1}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/END_MONTH_D1/${END_MONTH_D1}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/END_DAY_D1/${END_DAY_D1}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/END_HOUR_D1/${END_HOUR_D1}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/END_MINUTE_D1/${END_MINUTE_D1}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/END_SECOND_D1/${END_SECOND_D1}/" ${PROJ_DIR}/${DATE}/config/namelist.input

# End date: Domain 2
sed -i "s/END_YEAR_D2/${END_YEAR_D2}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/END_MONTH_D2/${END_MONTH_D2}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/END_DAY_D2/${END_DAY_D2}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/END_HOUR_D2/${END_HOUR_D2}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/END_MINUTE_D2/${END_MINUTE_D2}/" ${PROJ_DIR}/${DATE}/config/namelist.input
sed -i "s/END_SECOND_D2/${END_SECOND_D2}/" ${PROJ_DIR}/${DATE}/config/namelist.input
